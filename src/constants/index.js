...
const expCards = [
  {
    ...
    responsibilities: [
      "Migrated legacy applications to Django and FastAPI, increasing system efficiency by 5% and reducing dev cycles by 25%.",
      "Redesigned the UI/UX and built complete backend APIs in Django for a Multi-Level Marketing (MLM) platform with 5000+ users, leading to a 40% boost in client revenue.",
  ...
  },
  {
    ...
    responsibilities: [
      "Automated Telegram-based user engagement using Python and NodeJS bots, improving communication reach by 10%.",
